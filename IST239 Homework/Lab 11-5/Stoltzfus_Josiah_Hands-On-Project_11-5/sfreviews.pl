#!/usr/bin/perl
# For my local machine: #!C:/Strawberry/perl/bin/perl.exe
...
my @articles = (
    { searchkey => "GW",
      content => "<header>
                     <h1>The Shadow of the Torturer</h1>
                     <h2>by Gene Wolfe</h2>
                  </header>
    ...
    { searchkey => "RAH",
      content => "<header>
                     <h1>The Moon is a Harsh Mistress</h1>
                  ...
                  <p>I think it's because the novel is <em>not</em> really about the 
                     ...
                     economics ... no, wait, it's about artificial intelligence... hold on, it's 
                  ...
                  <p>In this novel, Heinlein introduced the famous concept - TANSTAAFL - 
                     ...
                     evident on the moon, where even air most be purchased. 
                     Death by suffocation is always only a few inches 

/*
Josiah Stoltzfus, June 14, 2025, IST239-W01, Hands-On Project 3-3

In Hands-On Project 3-3, I learned how to use a for loop to iterate through an array and access data from multiple related arrays. 
I also learned how to insert a string into a webpage by setting the innerHTML of an element retrieved using its tag name.
*/
...
// Create and initialize variable as an empty string
let htmlCode = "";

// This loop iterates through the titles array and builds an HTML string. 
// For each item, it appends a table row containing the corresponding title, rating, summary, and link.
// The final result is stored in the htmlCode variable so it can be inserted into the web page.
for (let i = 0; i < titles.length; i++) {
    htmlCode += "<tr>"; // opening <tr> tag
...
// Create a variable to store the first "tbody" element found in the document using its tag name
let tableBody = document.getElementsByTagName("tbody")[0];
// Update the innerHTML of the element with the htmlCode string

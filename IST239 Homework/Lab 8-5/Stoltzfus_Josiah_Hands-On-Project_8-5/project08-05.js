...
In Hands-On Project 8-5, I learned how to correctly use JSON.parse to read data from a file and how to create an object using the "new" keyword. I fixed errors where JSON.parse was called
incorrectly, and added the missing "new" keyword when creating the chessSet object.
*/
...
getLogButton.onchange = function() {
   ...
   fr.onload=function(){ 
      ...
      // FIXED: Changed 'json.parse' to 'JSON.parse'. 
      ...
      // FIXED: added 'new' keyword when creating the chessSet object.
